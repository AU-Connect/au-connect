            ...
            <div className="w-full max-w-md relative z-10 flex flex-col items-center">
                ...
                <div className="w-full space-y-4 animate-in fade-in slide-in-from-bottom-8 duration-900 pt-2">
                    ...
                    <Button
                        ...
                        variant="secondary"
                        className="w-full h-12 bg-white hover:bg-red-100 text-red-500 hover:text-red-600 font-semibold rounded-xl flex items-center justify-center gap-3 transition-all border border-slate-100 hover:border-red-100 shadow-sm active:scale-[0.98]"
                    >
